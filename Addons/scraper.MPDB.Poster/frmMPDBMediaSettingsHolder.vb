...
Public Class frmMPDBMediaSettingsHolder
...
#Region "Methods"
    ...
    Private Sub btnDown_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDown.Click
        ...
        If order < ModulesManager.Instance.externalPosterScrapersModules.Count - 1 Then
            ...
            ModulesManager.Instance.externalPosterScrapersModules.FirstOrDefault(Function(p) p.AssemblyName = MPDB_Poster._AssemblyName).ScraperOrder = order + 1
